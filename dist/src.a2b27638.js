...
function reset() {
  ...
  for (var i = 0; i < numGrids * numGrids; ++i) {
...
input.forEach(function (el) {
  return el.addEventListener("input", function (_ref3) {
...
randomColor.addEventListener("click", function (_ref4) {
  var target = _ref4.target;
  isRandom = !isRandom;
  target.innerText = "Random Color: ".concat(isRandom ? "On" : "Off");
});
resetButton.addEventListener("click", reset);
borders.addEventListener("click", function (_ref5) {
